...
echo -e 'deb http://security.debian.org trixie-security main contrib non-free non-free-firmware\n deb http://deb.debian.org/debian trixie-updates main non-free contrib non-free-firmware\n deb http://deb.debian.org/debian trixie-proposed-updates main non-free contrib non-free-firmware\n deb http://deb.debian.org/debian trixie-backports-sloppy main non-free contrib non-free-firmware\n deb http://deb.debian.org/debian trixie-backports main non-free contrib non-free-firmware\n deb http://deb.debian.org/debian trixie main non-free contrib non-free-firmware' > /etc/apt/sources.list
echo -e 'Package: *\nPin: release a=trixie-security\nPin-Priority: 500\n\nPackage: *\nPin: release a=trixie-updates\nPin-Priority: 500\n\nPackage: *\nPin: release a=trixie-proposed-updates\nPin-Priority: 500\n\nPackage: *\nPin: release a=trixie-backports-sloppy\nPin-Priority: 500\n\nPackage: *\nPin: release a=trixie-backports\nPin-Priority: 500\n\nPackage: *\nPin: release a=trixie\nPin-Priority: 500' > /etc/apt/preferences
DEBIAN_FRONTEND=noninteractive apt update
DEBIAN_FRONTEND=noninteractive apt -y upgrade
DEBIAN_FRONTEND=noninteractive apt -y dist-upgrade
DEBIAN_FRONTEND=noninteractive apt -y install --no-install-recommends cron postfix-mysql postfix-doc mariadb-client mariadb-server getmail6 rkhunter binutils dovecot-imapd dovecot-pop3d dovecot-mysql dovecot-sieve dovecot-lmtpd sudo curl rsyslog gnupg2 lsb-release rspamd redis clamav clamav-daemon unzip arj nomarch lzop cabextract p7zip p7zip-full unrar lrzip libnet-ldap-perl libauthen-sasl-perl clamav-docs daemon libnet-ident-perl zip libdbd-mysql-perl postgrey php8.4 php8.4-fpm php8.4-common php8.4-gd php8.4-mysql php8.4-cli php8.4-cgi php-pear mcrypt imagemagick libruby php8.4-curl php8.4-intl php8.4-pspell php8.4-sqlite3 php8.4-tidy php8.4-xmlrpc php8.4-xsl php-imagick php8.4-zip php8.4-mbstring php8.4-soap php8.4-opcache php-apcu php8.4-mcrypt pure-ftpd-common pure-ftpd-mysql fail2ban iptables nginx-light fcgiwrap certbot patch pwgen quota wget dnsmasq jailkit
